...
function apply_freeze(frm, freeze_info) {
    ...
    if (freeze_info.freeze_type === 'bill_sent') {
        ...
        let protected_fields = ['candidate_name', 'job_opening', 'added_by', 'joining_date', 
                                'offered_amount', 'remarks_for_invoice', 'invoice_ref'];
        ...
        // Freeze child table
        if (frm.fields_dict['interview_child_table'] && frm.fields_dict['interview_child_table'].grid) {
