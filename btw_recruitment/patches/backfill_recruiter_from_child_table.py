...
for opening in openings:
	...
	rows = frappe.get_all(
		...
		filters={"parent": opening, "parenttype": "DKP_Job_Opening", "parentfield": "assign_recruiter"},
	...
	if recruiter:
		frappe.db.set_value("DKP_Job_Opening", opening, "recruiter", recruiter, update_modified=False)
		updated += 1
	else:
		blank += 1
